...
public typealias PhotosViewControllerDownloadButtonTapped = (_ photo: PhotoViewable) -> ()
...
public class PhotosViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    public var downloadButtonTappedHandler: PhotosViewControllerDownloadButtonTapped?
...
extension PhotosViewController {
    ...
    private func setupOverlayView() {
        ...
        overlayView?.downLoadButton.addTarget(self, action: #selector(downloadButtonTapped), for: .touchUpInside)
    }
    ...
    @objc private func downloadButtonTapped(sender: UIButton) {
        if let currentPhoto = currentPhoto {
            guard let downloadButtonTappedHandler = self.downloadButtonTappedHandler else { return }
